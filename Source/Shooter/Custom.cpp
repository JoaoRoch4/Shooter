...
inline FString ACustom::IntToString (const int32 Int)  {
    FString IntString {FString::FromInt(Int)}; return IntString;
}

inline FString ACustom::RealToString (const float Float) {
    FString FloatString {FString::SanitizeFloat (Float)}; return FloatString;
}

inline FString ACustom::DoubleToString(const double Double) {
	FString DoubleString {FString::SanitizeFloat(Double)}; return DoubleString;
}
