...
void UShooterAnimInstance::UpdateAnimationProperties(float DeltaTime) {
	...
	MovementOffsetYaw =
	    UKismetMathLibrary::NormalizedDeltaRotator(MovementRotation,
	        AimRotation)
	        .Yaw;
...
void UShooterAnimInstance::TurnInPlace() {
	...
	RootYawOffset =
	    UKismetMathLibrary::NormalizeAxis(RootYawOffset - TIPYawDelta);
	...
	if (Turning > 0) {
	    ...
	    RootYawOffset > 0 ? RootYawOffset -= DeltaRotation
		...
		RootYawOffset > 0 ? RootYawOffset -= YawExcess
